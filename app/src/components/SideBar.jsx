        ...
        tagsHTML.push(
          <li className="editing" key={tags[i].id} onClick={clickHandler}>
            <input
              ...
              onBlur={completeHandler}
            />
            <span className="tags__count">{tags[i].count}</span>
          </li>
        );
      } else if (this.state.selectedTag == tags[i].id) {
        // If tag is selected
        tagsHTML.push(
          <li className="selected" key={tags[i].id} onClick={clickHandler}>
            ...
            <span
              ...
              onClick={() => {
                this.startRenameTag(tags[i].id);
              }}
            >
              Rename
            </span>
            <span className="tags__button" onClick={deleteHandler}>
              Delete
            </span>
          </li>
        );
    ...
    return (
      <ul className="tags">
        <li onClick={clickHandler}>
          All
          <span className="tags__count">{allCount}</span>
        </li>
        {tagsHTML}
      </ul>
    );
  ...
  render() {
    return (
      <div className="sidebar">
        <h2>
          Tags
          <span className="icon__button" onClick={this.newTag}>
            +
          </span>
        </h2>
        {this.getTags()}
