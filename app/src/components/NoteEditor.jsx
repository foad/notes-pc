...
import {Editor, EditorState, ContentState, EditorChangeType, SelectionState} from 'draft-js'
...
export default class NoteEditor extends Component {
    ...
    render () {
        return (
            <Editor editorState={EditorState.acceptSelection(this.state.editorState, this.state.selectionState)} onBlur={this.onBlur} onChange={this.onChange} />
        )
    }
}
